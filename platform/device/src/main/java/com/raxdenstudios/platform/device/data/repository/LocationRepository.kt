...
internal class LocationRepositoryImpl(
    private val locationManager: com.raxdenstudios.platform.device.data.LocationManager,
) : com.raxdenstudios.platform.device.data.repository.LocationRepository {
